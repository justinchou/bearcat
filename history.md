1.0.9 / 2018-03-04
==================
* 解决Bug: model中使用 $pack 设置内容, 触发某个约束返回错误后仍会设置成功.
* 解决Bug: model中带有自定义属性值的内置constraint, 多次调用会覆盖前面的自定义值 - 改用prototype模式

1.0.8 / 2018-03-02
==================
* 解决bug: 开启热更新后, 通过bearcat.stop无法停止程序.
* 解决bug: aop的advice方法内定义 $ 魔术语法糖只能使用var声明变量, 使用let/const无效

1.0.7 / 2018-02-28
==================
* 规范化文件命名, 文件均以 bearcatjs 命名, 变量均沿用原有 bearcat.

1.0.6 / 2018-02-28
==================
* 紧急修复Bug, 浏览器模式下无法通过自动加载导出 Bearcat.meta 声明的对象.
...
1.0.4 / 2018-02-28
==================
* 解决浏览器支持AOP的问题, 增加 bearcat.meta 方法.
* 取替原有老版本代码覆盖率工具, 使用mocha-Istanbul替代之.

1.0.3 / 2018-02-27
==================
* 去掉Bearcat自带的命令行, 移植到 BearcatJS-Cli 工程中

1.0.2 / 2018-02-27
==================
* 升级依赖模块, 解决高版本NodeJS已经不支持某些特性问题
* 更新官网地址
* 更名为BearcatJS
