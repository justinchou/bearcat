...
ModelProxy.prototype.$pack = function(data) {
	...
	// todo when value is array/object type, need to clone deep
    var old = {};
    for (var key in data) {
        var value = data[key];
        old[key] = model[key];
 ...
 *
 * @param  {String} method invoke method name
 ...
 *
 * @param {Object} resultModel
 * @param {Object} modelResultMap
 * @return {Object|Boolean} Error|true
 * @api private
 * @private
 */
